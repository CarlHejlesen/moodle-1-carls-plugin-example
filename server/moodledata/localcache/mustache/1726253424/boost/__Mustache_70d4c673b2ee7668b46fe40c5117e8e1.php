...
class __Mustache_70d4c673b2ee7668b46fe40c5117e8e1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <button id="calendarviewdropdown" type="button" class="btn btn-outline-secondary dropdown-toggle ms-1 me-2 mb-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
';
